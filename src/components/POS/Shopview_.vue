            ...
            <div
                ...
                <div class="flex items-center justify-center w-full gap-4 mb-6">
                    <RouterLink :to="{ name: 'requestshop' }">
                        <button
                            class="flex justify-center items-center p-2 bg-gradient-to-tr from-[#ffd84d] via-[#fff099] to-[#ffd94d] shadow-md rounded-box transition-transform duration-500 hover:scale-110 focus:underline focus:underline-offset-2">
                            <p
                                class="pl-1 text-[14px] lg:text-base font-sarabun text-[#001f54] font-semibold hover:underline hover:underline-offset-2 focus-visible:underline focus-visible:underline-offset-2">
                ...
                <h1 class="font-sarabun text-2xl font-bold mb-3">ร้านค้าของฉัน</h1>
                <!-- Search Bar -->
                    ...
                    <table class="w-full text-sm text-left text-gray-500 rounded-b-xl table-auto min-w-[700px]">
                        <thead class="text-gray-700 uppercase bg-[#e6f2f4]">
                            <tr>
                                ...
                                <th class="px-6 py-3 font-sarabun font-semibold lg:text-base">ดูสินค้าในร้าน</th>
                        ...
                        <tbody v-if="currentItems.length > 0">
                            <tr v-for="(item, index) in currentItems" :key="item.id || index"
                                ...
                                <td class="px-6 py-4 font-sarabun">{{ item.vproduct }}</td>
